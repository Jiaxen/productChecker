...
The sample config here isn't the product I originally wanted, just an example, which can be reconfigured for other websites and products.

With some modifications, useful for booking padel/tennis courts too!